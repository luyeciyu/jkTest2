...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/cargo/shippingorder/insert.action','_self');this.blur();">确定</a></li>
<%-- <li id="print"><a href="#" onclick="formSubmit('${ctx}/cargo/shippingorder/print','_self');this.blur();">打印</a></li>
...
<div class="textbox" id="centerTextbox">
    ...
    <div class="textbox-title">
		...
		<input type="radio" name="orderType" value="0" <c:if test="${obj.orderType == 0}">checked</c:if> class="input">海运
		<input type="radio" name="orderType" value="1" <c:if test="${obj.orderType == 1}">checked</c:if> class="input">空运
		</span>
	</div> 
    </div>
    </div>
		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"> 
					<input type="text" style="width:90px;" name="loadingDate" dataType="日期" dispName="装期" value="<fmt:formatDate value="${obj.loadingDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/> 
				</td>
	            <td class="columnTitle">效期：</td>
	            <td class="tableContent">
					<input type="text" style="width:90px;" name="limitDate" dataType="日期" dispName="效期" value="<fmt:formatDate value="${obj.limitDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/> 
				</td>
	        </tr>
	        <tr>
	            ...
	            <td class="tableContent" colspan="4">
					&nbsp;
					<input type="checkbox" name="isBatch" value="1" <c:if test="${obj.isBatch==1}">checked</c:if> class="input" style="width:20px;"/>分批
					<input type="checkbox" name="isTrans" value="1" <c:if test="${obj.isTrans==1}">checked</c:if> class="input" style="width:20px;"/>转船
