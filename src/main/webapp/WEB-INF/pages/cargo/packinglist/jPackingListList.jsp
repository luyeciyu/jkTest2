...
<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
	...
	<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
		...
		<td><a href="packingListAction_toview?id=${obj.id}">${obj.invoiceNo}</a></td>
		<td>${obj.exportNos}</td>
		<td> <fmt:formatDate value="${obj.invoiceDate}" pattern="yyyy-MM-dd"/> </td>
		<td>${obj.marks}</td>
		<td>${obj.descriptions}</td>
	</tr>
	</c:forEach>
