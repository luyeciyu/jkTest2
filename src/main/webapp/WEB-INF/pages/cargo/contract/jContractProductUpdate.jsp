...
<form method="post">
	...
	<input type="text" name="contractId" value="${obj.contractId}" hidden="hidden"/>
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/cargo/contractproduct/update.action','_self');">确定</a></li>
<li id="back"><a href="${ctx}/cargo/contractproduct/tocreate.action?contractId=${obj.contractId}">返回</a></li>
</ul>
    </div>
</div>
</div>
