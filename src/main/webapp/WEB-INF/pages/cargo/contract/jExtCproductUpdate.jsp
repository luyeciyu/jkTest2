...
<form method="post">
	...
	<input type="text" name="contractProductId" value="${obj.contractProductId}" hidden="hidden"/>
...
<li id="back"><a href="${ctx}/cargo/extcproduct/tocreate.action?contractProductId=${obj.contractProductId}">返回</a></li>
</ul>
    </div>
</div>
</div>
