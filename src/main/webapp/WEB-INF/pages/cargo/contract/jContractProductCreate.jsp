...
<body>
<form method="post">
	<input type="text" name="contractId" value="${contractId}" hidden="hidden"/>
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/cargo/contractproduct/insert.action','_self');">确定</a></li>
